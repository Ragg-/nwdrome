...
nwdrome.plugin.addRenderer(function(config) {
    ...
    // Plugin info
    var ID          = "jsdrome.danmaku",
        DESCRIPTION =
            "Danmaku\n"
            + "  danmaku like particle graphics drawing plugin\n"
            + "  Audio insensitive\n",
        THUMBNAIL = config.url + 'danmaku.png';
    ...
    Danmaku.id = ID;
    Danmaku.description = DESCRIPTION;
    Danmaku.thumbnail = THUMBNAIL;
    ...
    ////////////////////////
    Danmaku.prototype.onStart = noop;

    Danmaku.prototype.onStop = noop;
    ...
    Danmaku.prototype.onKeydown = noop;

    Danmaku.prototype.onResize = function(width, height) {
