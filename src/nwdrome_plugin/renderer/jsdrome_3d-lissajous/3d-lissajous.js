...
nwdrome.plugin.addRenderer(function (config) {
    // Plugin information
    var ID          = "jsdrome.3d-lissajous",
        DESCRIPTION =
            "Lissajous\n"
            + "  3D lissajous figure plugin\n"
            + "  Audio affects figure size\n",
        THUMBNAIL   = config.url + '3d-lissajous.png';

    function noop() {}

    var Lissajous = function(canvas) {
        this.canvas = canvas;
    ...
    Lissajous.id = ID;
    Lissajous.description = DESCRIPTION;
    Lissajous.thumbnail = THUMBNAIL;
    ...
    Lissajous.prototype.onStop = noop;

    Lissajous.prototype.onFade = noop;
    ...
    Lissajous.prototype.onKeydown = noop;
    ...
    Lissajous.prototype.onResize = function(width, height) {
        this.camera.aspect = width / height;
        this.camera.updateProjectionMatrix();
        this.renderer.setSize(width, height);
    }

    Lissajous.prototype.onMidi = noop;
