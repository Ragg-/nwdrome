...
nwdrome.plugin.addRenderer(function (config) {
    // Plugin information
    var ID          = "jsdrome.3d-matrix",
        DESCRIPTION =
            "Matrix\n"
		  + "  3D Matrix plugin\n",
        THUMBNAIL   = config.url + '3d-matrix.png';
    ...
    var Matrix = function(canvas) {
        ...
        // particle
        var texture =THREE.ImageUtils.loadTexture(config.url + 'images/particle.png');
    ...
    Matrix.prototype.onStop = noop;

    Matrix.prototype.onFade = noop;

    Matrix.prototype.onTimer = function() {
        this.render();
    }

    Matrix.prototype.onKeydown = noop;

    Matrix.prototype.onAudio = noop;

    Matrix.prototype.onResize = function(width, height) {
        this.camera.aspect = width / height;
        this.camera.updateProjectionMatrix();
        this.renderer.setSize(width, height);
    }

    Matrix.prototype.onMidi = noop;
