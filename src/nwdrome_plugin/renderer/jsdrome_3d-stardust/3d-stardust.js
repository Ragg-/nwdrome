...
nwdrome.plugin.addRenderer(function(config) {
    ...
    // Plugin info
    var ID          = "jsdrome.stardust",
        DESCRIPTION =
            "Stardust\n"
            + "3D stardust graphics plugin\n"
            + "Audio changes color\n\n"
            + "[D][C] Change color ",
        THUMBNAIL   = config.url + '3d-stardust.png';

    var Stardust = function(canvas) {
        // 初期化
    ...
    Stardust.id = ID;
    Stardust.description = DESCRIPTION;
    Stardust.thumbnail = THUMBNAIL;
    ...
    Stardust.prototype.onFade = function() {}
    ...
    */
    ...
    Stardust.prototype.onResize = function(width, height) {
